...
- Instructions pour réaliser un type spécifique de tâche
- Étapes que doit suivre Coworker
- Informations et sources de données à utiliser
- Format de sortie attendu
- Conseils sur le moment où le workflow doit être appliqué

## Pourquoi les équipes utilisent des compétences

De nombreuses organisations effectuent les mêmes types de tâches à plusieurs reprises, notamment :

- Rapports de performances hebdomadaires
- Analyse du parcours client
- Résumés
- Révisions standardisées des activités
...
Au lieu de cela, les compétences définissent la manière dont le travail doit être effectué tandis que l’accès aux données reste régi par les applications Adobe connectées, les autorisations et les contrôles organisationnels.

Cette séparation permet aux équipes de normaliser les processus tout en maintenant une sécurité et une gouvernance appropriées.
