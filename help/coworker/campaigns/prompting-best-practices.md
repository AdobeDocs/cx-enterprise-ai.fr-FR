...
|-|-|-|
| **C - Contexte** | Contexte de votre campagne, produit ou situation | Aide l’IA à comprendre la vue d’ensemble |
...
<p>Focus sur les résumés marketing avec des conseils spécifiques sur l’extraction</p>
<p>Rédigez vos invites pour générer l'intention souhaitée</p>
</td>
<td>
<p>Demander des modifications structurelles, de style ou de modification d’image dans les prompts</p>
<p>Utiliser des instructions vagues comme « promouvoir notre produit »</p>
...
<th>✗ des opérations dans l’éditeur</th>
</tr>
</thead>
<tbody>
<tr style="border: 0;">
...
✓ **Objectif clair** : indique clairement l’action, le produit/service, la valeur et le contexte.
