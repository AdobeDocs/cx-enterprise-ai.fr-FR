...
## Accès à Data Insights Agent dans les applications Experience Cloud
...
>[!MORELIKETHIS]
>
>[Paramètres des composantsDictionnaire de donnéesApprouver la mesure calculéePartage de segments ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/segments/seg-share)
