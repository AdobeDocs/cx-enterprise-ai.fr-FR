---
title: Outils Journey Optimizer dans la passerelle de collègue CX
...
Utilisez les outils de produit Adobe Journey Optimizer pour inspecter les configurations des campagnes, des parcours et des canaux à partir d’un client compatible MCP. Ces outils sont disponibles via la passerelle [CX Coworker](overview.md) lorsque votre organisation est activée et que votre compte utilisateur dispose des autorisations Journey Optimizer requises.

Pour plus d’informations, voir [Utilisation des clients MCP](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/integrations/ajo-mcp){target="_blank"} dans la documentation de Adobe Journey Optimizer.
...
Pour plus d’informations, voir [Outils de gestion de contenu](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/start/ajo-coworker-skills#content-management){target="_blank"} dans la documentation de Adobe Journey Optimizer.
