...
| **Experience Platform** | Schémas, jeux de données, gouvernance des données, Query Service, événements d’audit et évaluations des contrôles d’intégrité des sandbox (lecture seule) | Beta | [Outils ](aep-mcp.md) |
