---
title: IA dédiée aux agences dans les applications CX Enterprise
description: Découvrez où l’IA dédiée aux agents est disponible dans les applications CX Enterprise.
...
Adobe [Experience Platform Agent Orchestrator](../agents/agent-orchestrator.md) alimente les fonctionnalités d’IA agentic dans les applications CX Enterprise.

Les agents automatisent les tâches, fournissent plus rapidement des informations et rationalisent les workflows. Ainsi, les équipes peuvent travailler plus efficacement et tirer le meilleur parti de CX Enterprise.

Les agents d’IA CX Enterprise sont disponibles dans :

* [Applications CX Enterprise existantes](#existing-apps)
* [Applications CX Enterprise primées sur l’IA](#ai-first-apps)

Les sections suivantes décrivent ces deux manières d’activer l’IA dédiée aux agents dans CX Enterprise.

## Applications CX Enterprise existantes {#existing-apps}

Dans les applications existantes, vous pouvez utiliser le langage naturel pour apprendre aux agents Adobe Experience Platform via l’interface de conversation dans l’assistant [AI](../ai-assistant/ai-assistant-ui.md). L’assistant AI est disponible en mode plein écran et dans le rail droit.

Les agents peuvent être activés dans les applications CX Enterprise existantes pour les clients appartenant à l’une des catégories suivantes :
...
| [&#128279;](../agents/ajo-agent.md) | Permettez à vos équipes d’analyser et d’optimiser rapidement les parcours clients multipoint à grande échelle. | <ul><li>Adobe Journey Optimizer (éditions B2B et B2C)</li></ul> | |
| [Agent du support produit](../agents/product-support.md) | Résolvez les problèmes d’assistance sans quitter vos workflows, créez des tickets d’assistance clientèle et suivez la progression des cas à l’aide de l’assistant AI. | <ul><li>Real-Time CDP (éditions B2B, B2C et B2P)</li><li>Adobe Journey Optimizer (éditions B2B et B2C)</li><li>Customer Journey Analytics (éditions B2B et B2C)</li><li>Adobe Experience Manager</li></ul> | |
| [Adobe Marketing Agent pour Microsoft 365 Copilot](../agents/ama-ms.md) | Connecte Experience Platform directement à Microsoft 365 Copilot. Vous pouvez poser des questions en langage naturel dans les applications Microsoft 365, telles que Teams, Word, Powerpoint et Excel, pour récupérer instantanément des informations marketing d’Experience Platform sans interrompre votre workflow. | <ul><li> Adobe Agent Orchestrator avec prise en charge d’Audience Agent, Journey Agent, Customer Journey Analytics Data Insights et Experience Platform Operational Insights</li></ul> | |

## Applications CX Enterprise primées sur l’IA {#ai-first-apps}

Les applications axées sur l’IA sont créées principalement à l’aide d’une IA générative ou agentique. Ils utilisent l’IA générative ou agentique pour des tâches clés, et les fonctionnalités agentiques sont déjà incluses dans la licence de l’application AI-first. Par conséquent, ils ne nécessitent pas de licence Experience Platform Agent Orchestrator.

Le tableau suivant répertorie les agents Experience Platform disponibles en tant qu’applications IA-first. Elles sont activées en attribuant une licence à ces applications IA-first :
...
| [&#128279;](https://experienceleague.adobe.com/en/docs/brand-concierge/content/documentation/overview) | Améliorez la conversion et l’engagement grâce à une découverte intelligente et contextuelle des produits, adaptée aux préférences et aux comportements individuels. | <ul><li>Adobe Brand Concierge</li></ul> |

## Plus d’aide sur cette rubrique

* [Outils CX Enterprise Agentic](https://experienceleague.adobe.com/en/docs/cx-enterprise-agentic-tools/using/overview#adobe-cx-enterprise-agentic-tools)
* [Tâches de l’agent et consommation du crédit de l’IA](ai-credit-consumption.md)
* Accueil de la documentation [AI](https://experienceleague.adobe.com/en/docs/ai) Accueil de la documentation
* [Présentation des agents dans Experience Manager as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/overview)
